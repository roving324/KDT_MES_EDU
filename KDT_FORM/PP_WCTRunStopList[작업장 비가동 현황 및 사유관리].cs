...
namespace KDT_Form
{
    public partial class PP_WCTRunStopList : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_WCTRunStopList_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "RSSEQ"         , "순번"          , GridColDataType_emu.VarChar   ,  80, Infragistics.Win.HAlign.Left  , false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "TIMEDIFF"      , "소요시간(분)"  , GridColDataType_emu.VarChar   ,  80, Infragistics.Win.HAlign.Right ,  true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "EDITOR"        , "수정자"        , GridColDataType_emu.VarChar   ,  80, Infragistics.Win.HAlign.Left  ,  true, false);
